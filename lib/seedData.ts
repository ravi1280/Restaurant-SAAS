...
export const seedMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    description: 'Toasted triple-decker sandwich with grilled chicken, bacon, egg, lettuce, tomato, and mayo. Served with fries.',
    categoryId: 'cat-mains',
    price: 1450,
    costPrice: 500,
    emoji: '🥪',
    ...
    station: 'hot',
    soldCount: 110,
    linkedInventoryIds: ['inv-bread', 'inv-chicken'],
    upsellItemIds: ['item-10'],
  ...
  },
  {
    ...
    description: 'Prime ground beef patty with melted cheddar, caramelized onions, pickles, and house sauce on a brioche bun.',
    categoryId: 'cat-mains',
    price: 1650,
    costPrice: 600,
    emoji: '🍔',
